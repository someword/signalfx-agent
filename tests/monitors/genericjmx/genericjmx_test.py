...
def test_genericjmx_in_k8s(agent_image, minikube, k8s_observer, k8s_test_timeout):
    monitors = [
    ...
    yamls = [os.path.join(os.path.dirname(os.path.realpath(__file__)), y) for y in ["genericjmx.yaml"]]
